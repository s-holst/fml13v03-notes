...
SPI2.0 contents:
```
header.magic=0x42575345
header.num_entries = 4
./spi2_0_FIRMWARE.bin
  h.offset = 327680 0x50000
  h.size = 1738 0x6ca end: 0x506ca
  h.sign_type = 0 h.key_index = 0
  h.payload_type = FIRMWARE h.last_flag = 0
  s.link_addr = 0x0
  s.payload_offset = 512 0x200 (ignored)
  s.payload_size = 1738 0x6ca end: 0x8ca
  s.load_addr = 0x30008000
  s.entry_addr = 0x30008000
  s.payload_flags = 0
  s.digest_mthd = 0
  s.encrypted_mthd = 0
  s.vid = 0
  s.lang = b'eng'
  s.mid = 0
  s.payload_type = FIRMWARE
  s.boot_flags = 0
  s.devid = 0
  s.params = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
  s.load_info = Container(load_addr=0, init_ofs=0, destroy_ofs=0, ioctl_ofs=0, load_flags=0, irq_num=0, irq_ofs=0)
  s.digest = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
./spi2_0_DDR.bin
  h.offset = 331776 0x51000
  h.size = 708608 0xad000 end: 0xfe000
  h.sign_type = 0 h.key_index = 0
  h.payload_type = DDR h.last_flag = 0
  s.link_addr = 0x0
  s.payload_offset = 3040 0xbe0 (ignored)
  s.payload_size = 708608 0xad000 end: 0xadbe0
  s.load_addr = 0x59000000
  s.entry_addr = 0x59000000
  s.payload_flags = 0
  s.digest_mthd = 0
  s.encrypted_mthd = 0
  s.vid = 0
  ...
  s.digest = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
./spi2_0_D2D.bin
  h.offset = 1044480 0xff000
  h.size = 743212 0xb572c end: 0x1b472c
  h.sign_type = 0 h.key_index = 0
  h.payload_type = D2D h.last_flag = 0
  s.link_addr = 0x0
  s.payload_offset = 712448 0xadf00 (ignored)
  s.payload_size = 743212 0xb572c end: 0x16362c
  s.load_addr = 0x59000000
  s.entry_addr = 0x59000000
  s.payload_flags = 0
  s.digest_mthd = 0
  ...
  s.load_info = Container(load_addr=0, init_ofs=0, destroy_ofs=0, ioctl_ofs=0, load_flags=0, irq_num=0, irq_ofs=0)
  s.digest = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
./spi2_0_BOOTLOADER.bin
  h.offset = 1789952 0x1b5000
  h.size = 4036040 0x3d95c8 end: 0x58e5c8
  h.sign_type = 0 h.key_index = 0
  h.payload_type = BOOTLOADER h.last_flag = 1
  s.link_addr = 0x0
  s.payload_offset = 1456448 0x163940 (ignored)
  s.payload_size = 4036040 0x3d95c8 end: 0x53cf08
  s.load_addr = 0x80000000
  s.entry_addr = 0x80000000
  s.payload_flags = 0
  s.digest_mthd = 1
  s.encrypted_mthd = 0
  s.vid = 0
...
./spi3_0_FIRMWARE.bin
  h.offset = 327680 0x50000
  h.size = 1658 0x67a end: 0x5067a
  h.sign_type = 0 h.key_index = 0
  h.payload_type = FIRMWARE h.last_flag = 0
  s.link_addr = 0x0
  s.payload_offset = 512 0x200 (ignored)
  s.payload_size = 1658 0x67a end: 0x87a
  s.load_addr = 0x30008000
  s.entry_addr = 0x30008000
  s.payload_flags = 0
  s.digest_mthd = 0
...
./spi3_0_DDR.bin
  ...
  h.payload_type = DDR h.last_flag = 0
  s.link_addr = 0x0
  s.payload_offset = 2944 0xb80 (ignored)
  s.payload_size = 708608 0xad000 end: 0xadb80
  s.load_addr = 0x79000000
  s.entry_addr = 0x79000000
  s.payload_flags = 0
  s.digest_mthd = 0
  s.encrypted_mthd = 0
  s.vid = 0
  ...
  s.devid = 0
  s.params = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
  s.load_info = Container(load_addr=2030043136, init_ofs=0, destroy_ofs=0, ioctl_ofs=0, load_flags=0, irq_num=0, irq_ofs=0)
  s.digest = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
./spi3_0_D2D.bin
  h.offset = 1044480 0xff000
  h.size = 734444 0xb34ec end: 0x1b24ec
  h.sign_type = 0 h.key_index = 0
  h.payload_type = D2D h.last_flag = 1
  s.link_addr = 0x0
  s.payload_offset = 712352 0xadea0 (ignored)
  s.payload_size = 734444 0xb34ec end: 0x16138c
  s.load_addr = 0x79000000
  s.entry_addr = 0x79000000
  s.payload_flags = 0
  s.digest_mthd = 0
